...
public class LinkedList : IEnumerable<int>
{
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                // If the location of 'value' is at the head, then we can
                // call remove_head to remove it.
                if (curr == _head)
                {
                    RemoveHead();
                }
                // If the location of 'value' is at the tail, then we can
                // call remove_tail to remove it.
                else if (curr == _tail)
                {
                    RemoveTail();
                }
